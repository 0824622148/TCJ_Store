...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "app-gradient":
          "linear-gradient(135deg, #0A0118 0%, #0F0A1A 50%, #160D2E 100%)",
        "forest-gradient":
          "linear-gradient(135deg, #160D2E 0%, #2D1557 100%)",
        "gold-gradient":
      ...
      boxShadow: {
        ...
        gold: "0 4px 20px rgba(168, 85, 247, 0.3)",
        green: "0 4px 20px rgba(22, 13, 46, 0.5)",
      },
    },
  },
