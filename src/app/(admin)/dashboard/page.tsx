...
const kpis = [
  { label: "Revenue Today", value: "$4,821", change: "+18.2%", positive: true, icon: DollarSign, color: "#22C55E" },
  { label: "Orders Today", value: "94", change: "+12%", positive: true, icon: Package, color: "#A855F7" },
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0D1F1A] border border-white/5 rounded-2xl p-5">
            ...
            <div className="space-y-3">
              {[
                { label: "Flower", pct: 42, color: "#22C55E" },
                { label: "Vapes", pct: 28, color: "#7EB8C9" },
                { label: "Edibles", pct: 18, color: "#A855F7" },
