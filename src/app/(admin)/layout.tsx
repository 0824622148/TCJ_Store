...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#060010] flex">
      {/* Sidebar */}
      <aside className="w-60 bg-[#0A0118] border-r border-white/5 flex flex-col">
        {/* Logo */}
        <div className="p-6 border-b border-white/5">
          <Link href="/home" className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-soft font-bold text-sm">The Cloud Junction</span>
