...
export default function AnalyticsPage() {
  ...
  return (
    <div className="p-6 text-soft">
      ...
      >
        {[
          { label: "YTD Revenue", value: "$802,400", change: "+24.3%", icon: TrendingUp, color: "#22C55E" },
          { label: "Total Customers", value: "8,421", change: "+31.2%", icon: Users, color: "#A855F7" },
      ...
      <div className="grid grid-cols-2 gap-4">
            ...
            {monthlyRevenue.map((v, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <motion.div
                  ...
                  style={{
                    background: i === 4
                      ? "linear-gradient(to top, #160D2E, #22C55E)"
                      : "rgba(34,197,94,0.2)",
                  }}
                />
              </div>
        ...
        <div className="bg-[#0D1F1A] border border-white/5 rounded-2xl p-5">
          ...
          <div className="space-y-4">
            {[
              { label: "New Customers", value: "2,341", pct: 28, color: "#22C55E" },
              { label: "Returning", value: "4,892", pct: 58, color: "#A855F7" },
        ...
        <div className="bg-[#0D1F1A] border border-white/5 rounded-2xl p-5">
          ...
          <p className="text-white/30 text-xs mb-4">Powered by machine learning â€” coming soon</p>
          <div className="space-y-3">
            {[
              { icon: "ðŸŽ¯", text: "Predict demand spikes for upcoming holidays" },
              { icon: "ðŸ¤–", text: "Auto-personalize product recommendations" },
              { icon: "ðŸ“¦", text: "Smart inventory reorder suggestions" },
              { icon: "ðŸ’¬", text: "Sentiment analysis from customer reviews" },
            ].map((item, i) => (
