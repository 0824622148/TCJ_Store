...
export default function AuthScreen() {
  ...
  return (
    <div className="relative w-full h-full flex flex-col overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0A0118] to-[#060010]" />
      ...
      <div className="relative z-10 flex flex-col h-full px-6 pt-16 pb-10">
        ...
        >
          <motion.div variants={cardReveal} className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-forest-gradient flex items-center justify-center p-0.5">
              <Image src="/images/tcj-logo.png" alt="The Cloud Junction" width={36} height={36} className="object-contain rounded-full" />
            </div>
            <span className="text-lg font-bold text-soft">The Cloud Junction</span>
          </motion.div>
