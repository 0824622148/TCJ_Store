...
const categoryCards = [
  { id: "Flower",       label: "Flower",       tag: "Premium Selection", subtitle: "50+ strains in stock",       bg: "/images/products/og-kush.png",                accent: "#22C55E" },
  { id: "Edibles",      label: "Edibles",      tag: "Lab Tested",        subtitle: "Gummies, chocolates & more", bg: "/images/products/midnight-berry-gummies.png", accent: "#A855F7" },
  { id: "Vapes",        label: "Vapes",        tag: "Top Shelf",         subtitle: "Distillate & live resin",    bg: "/images/products/pineapple-express.png",       accent: "#7EB8C9" },
  { id: "Concentrates", label: "Concentrates", tag: "Just Dropped",      subtitle: "Live resin & rosin",         bg: "/images/products/live-resin-wedding-cake.png", accent: "#A855F7" },
...
const banners = [
  { id: 0, title: "25% OFF", subtitle: "All Flower Today", tag: "Daily Deal", bg: "/images/banner-daily-deal.png", accent: "#22C55E" },
  { id: 1, title: "NEW ARRIVALS", subtitle: "Live Resin Collection", tag: "Just Dropped", bg: "/images/banner-new-arrivals.png", accent: "#A855F7" },
  { id: 2, title: "FREE DELIVERY", subtitle: "On Orders Over R750", tag: "Limited Time", bg: "/images/banner-free-delivery.png", accent: "#7EB8C9" },
];
      ...
      <div className="max-w-5xl mx-auto px-4 pb-24 md:pb-8 md:pt-6">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 bg-forest/30 border border-sage/20 rounded-xl px-3 py-2 w-fit">
            ...
            <span className="text-xs text-white/60">Johannesburg South, JHB</span>
                ...
                i === activeBanner ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      style={{ background: banner.accent, color: "#0A0118" }}
                    >
                      Shop Now
                    </motion.button>
                  </motion.div>
            ...
            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5 z-10">
              {banners.map((_, i) => (
                <button
                  ...
                  style={{ width: i === activeBanner ? 16 : 5, background: i === activeBanner ? "#22C55E" : "rgba(255,255,255,0.3)" }}
                />
              ))}
            </div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 flex items-end justify-between h-full p-5">
            <div>
              ...
              <h3 className="text-2xl font-black leading-tight mt-1.5" style={{ color: "#A855F7" }}>Join the Cloud</h3>
            ...
            <motion.button
              ...
              style={{ background: "#A855F7", color: "#0A0118" }}
            >
              Join Now
            </motion.button>
          </div>
