...
export default function ProductsScreen() {
  ...
  const sortLabels: Record<SortOption, string> = {
    popular: "Most Popular", "price-low": "Price: Lowâ†’High", "price-high": "Price: Highâ†’Low",
                ...
                <button
                  ...
                  style={
                    activeCategory === cat.id
                      ? { background: cat.color, borderColor: cat.color, color: "#0A0118" }
              ...
              >
                <GlassCard variant={product.isPremium ? "gold" : "default"} className="p-3">
                  <div className="relative h-28 md:h-36 flex items-center justify-center mb-2">
                    ...
                    {product.isPremium && <span className="absolute top-0 left-0 text-[9px] bg-gold/20 text-gold border border-gold/30 px-1.5 py-0.5 rounded-full font-bold">âœ¦ PREMIUM</span>}
                  </div>
