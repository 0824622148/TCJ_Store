...
export default function DesktopNav() {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 flex-col bg-[#0A0118]/95 backdrop-blur-xl border-r border-white/5 z-40">
      {/* Logo */}
      <div className="p-6 border-b border-white/5">
        <Link href="/home" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-forest-gradient flex items-center justify-center p-0.5 shadow-green">
            <Image src="/images/tcj-logo.png" alt="The Cloud Junction" width={36} height={36} className="object-contain rounded-full" />
          </div>
          <div>
            <h1 className="text-soft font-bold text-base leading-tight">The Cloud Junction</h1>
            <p className="text-white/30 text-[10px] tracking-wider uppercase">JHB South Delivery</p>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-white/5 space-y-2">
        ...
        <div className="px-4 py-3 rounded-2xl bg-forest/20 border border-sage/15">
          ...
          <p className="text-soft text-xs font-semibold">Johannesburg South, JHB</p>
